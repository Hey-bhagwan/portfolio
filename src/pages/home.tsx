...
export const Home = () => {
  ...
  return (
    <div className="h-screen">
      ...
      <div className="flex flex-col items-start  px-8 border-b border-gray-400"
        id="projects">
        <div>
        ...
        <div className="w-full  mt-12 px-3 ">
          ...
          <Card
            ...
            topic="Learning Hub"
            year="2025"
            pera=" An online learning platform offering self-paced courses in relevant skills/subjects to 
                  enhance expertise."
